...
/// Custom extractor for Bleacher Report (bleacherreport.com).
public struct BleacherReportExtractor: Extractor, Sendable {
    public let domain = "bleacherreport.com"

    public init() {}

    public var titleConfig: ExtractionConfig? {
        ExtractionConfig(selectors: [
            .css("h1.article__header__title"),
            .css("h1"),
