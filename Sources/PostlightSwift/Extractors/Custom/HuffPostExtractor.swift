...
/// Custom extractor for HuffPost (www.huffpost.com).
public struct HuffPostExtractor: Extractor, Sendable {
    public let domain = "www.huffpost.com"

    public init() {}

    public var titleConfig: ExtractionConfig? {
        ExtractionConfig(selectors: [
            .css("h1.headline__title"),
            .css("h1"),
